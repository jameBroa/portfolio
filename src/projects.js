...
import ScriptLogin from './images/auto-login-400x400.png'
import Portfolio from './images/portfolio-400x400.png';
import ILP from './images/ilp-400x400.png';
import SEPP from './images/sepp-400x400.png'
import Delta from './images/delta-400x400.png';
export const ALL_PROJECTS = [
    ...
    {title: "Automatic login script", desc:"This script automated the login experience when logging into Learn via MyEd from The University of Edinburgh. Users can setup their username and password within the script", tag:["python"], img:ScriptLogin},
    {title: "Portfolio Website", desc:"The website you are currently on! A way to showcase all of my self-guided coding adventures. Utilizes skills I've learnt over the years.", tag:['web'], img:Portfolio},
    {title: "Drone Delivery System", desc:"Relevant coursework which involved creating a Drone Food delivery system which would connect to a RESTful service to retrieve and categorize orders. It also generated flight path for drone delivery.", tag:["java"], img:ILP},
    {title: "Events Booking System", desc:"Relevant coursework which involved working in a group to build an Events Booking System built on the Command and Oberserver pattern. Involved heavy JUnit tests.", tag:["java"], img:SEPP},
    {title: "UNO Sense Android App", desc:"Internship experience at Delta electronics where I worked to create a prototype app which connected to their UNO sense device and display air quality information.", tag:["mobile"], img:Delta},
